...
class Aperture:
    ...
    def __init__(self, radial_area: PolarGrid, aperture_diameter: float):
        """
        ...
        self.__aperture = circ(radial_area.polar_grid, w=aperture_diameter)
    ...
    def aperture_diameter(self, aperture_diameter):
        ...
        self.__aperture = circ(self.radial_area.polar_grid, w=self.__aperture_diameter)
